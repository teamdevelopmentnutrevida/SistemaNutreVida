        ...
        <div>
            <div class="col-11" style="width:50%; float:left;">
                <div class="col-11" style="width:50%;">
					...
					<asp:TextBox ID="TextBox1" runat="server" placeholder="Número de cédula" CssClass="form-control"></asp:TextBox>
					<br />
				</div>
                <div class="col-11" style="width:50%;">
              ...
              <asp:TextBox ID="TextBox2" runat="server" placeholder="Nombre" CssClass="form-control"></asp:TextBox>
                ...
                <asp:TextBox ID="TextBox3" runat="server" placeholder="Fecha de nacimiento" CssClass="form-control"></asp:TextBox>
					<br />
				</div>
                 <div class="col-11" style="width:50%;">
                    <label class="form-label" for="tTel">Teléfono:</label><asp:Label runat="server" ID="Telef" Font-Size="Medium"></asp:Label>
               <asp:TextBox ID="TextBox4" runat="server" placeholder="Teléfono" CssClass="form-control"></asp:TextBox>
					 <br />
					  </div>
                 <div class ="col-11" style="width:50%;">
            ...
            <div style="width:50%; float:left;">
                ...
                <div class="col-11" style="width:50%;">
                 ...
                 <asp:TextBox ID="TextBox7" runat="server" placeholder="Ocupación" CssClass="form-control"></asp:TextBox>
					<br />
				</div>
                <div class="col-11" style="width:50%;">
                    <label class="form-label" for="tResid">Residencia</label><asp:Label runat="server" ID="Residencia" Font-Size="Medium"></asp:Label>
                <asp:TextBox ID="TextBox5" runat="server" placeholder="Dirección de residencia" CssClass="form-control"></asp:TextBox>
					<br />
				</div> 
                <div class="col-11" style="width:50%;">
